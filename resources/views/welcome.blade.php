...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>An Web-based Exam Billing Reporting Management System for JUST with Laravel Framework
</title>
...
footer p a {
  color: white;
    ...
    <body class="antialiased">
        <div class="fr" style="width: 1340px;margin-left: 10px;">
            @if (Route::has('login'))
                <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10" style="color:red">
                    @auth
