...
@include('nav')
      ...
      <div class="container col-md-6 card-body" >
              
              <h3 class="card-title" style="text-align:center;">Only One Degree</h3>
              <div class="card-title">
                      <a href="{{URL::to('/alldegree')}}"><button  class="btn btn-primary btn-ml deleteStudentBtn">Show All Degree List</button></a> 
                    </div>
