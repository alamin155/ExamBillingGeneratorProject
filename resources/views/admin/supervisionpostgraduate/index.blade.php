...
<body>
  @include('usernave')
     <div class="container col-6 card-body" style=" margin-left:263px; width:1055px; background-color:#e7e6e6; border: 2px solid #A8D08D">
      <div class="col-md-14 card-body" style="width:960px">
        <h2 class="my-2 text-center">All Supervision Thesis/Project/Plant Design (Post Graduate) List</h2>
          <a href="" class="btn btn-primary my-2" data-bs-toggle="modal" data-bs-target="#addModal">Add New Supervision Thesis/Project/Plant Design (Post Graduate)</a>
          @foreach($exams as $d)
      ...
      <div class="data-table col-md-10" style="width:1050px">
            <table class="table table-bordered" style="border: 2px;">
                      ...
                      <tr> 
                       ...
                       <td>
                      <a href="#" class="btn btn-primary update_supervisionpostgraduate_form" 
                      ...
                      <a href="#" class="btn btn-danger delete_supervisionpostgraduate" data-id="{{$d->id}}" >
  ...
  @include('admin.supervisionpostgraduate.modal')
  @include('admin.supervisionpostgraduate.edit')
  @include('admin.supervisionpostgraduate.ajax')
  {!! Toastr::message() !!}
