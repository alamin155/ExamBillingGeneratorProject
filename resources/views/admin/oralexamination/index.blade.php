...
<body>
  @include('usernave')
     <div class="container col-6 card-body" style=" margin-left:263px; width:1055px; background-color:#e7e6e6; border: 2px solid #A8D08D">
      <div class="col-md-14 card-body" style="width:960px">
        <h2 class="my-2 text-center">All Oral Examination ( Central Viva) List</h2>
          <a href="" class="btn btn-primary my-2" data-bs-toggle="modal" data-bs-target="#addModal">Add New Oral Examination ( Central Viva)</a>
          @foreach($exams as $d)
      ...
      <div class="data-table col-md-10" style="width:1050px">
            <table class="table table-bordered" style="border: 2px;">
                      ...
                      <tr> 
                       ...
                       <td>
                      <a href="#" class="btn btn-primary update_oralexamination_form" 
                      ...
                      <a href="#" class="btn btn-danger delete_oralexamination" data-id="{{$d->id}}" >
  ...
  @include('admin.oralexamination.modal')
  @include('admin.oralexamination.edit')
  @include('admin.oralexamination.ajax')
  {!! Toastr::message() !!}
</body>
</html>
@endsection
