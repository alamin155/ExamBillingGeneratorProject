...
<div class="modal fade" id="updateModal" tabindex="-1" aria-labelledby="updateModalLabel" aria-hidden="true">
  <form method="post" action=""  id="updateoralexaminationForm">
   @csrf
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="updateModalLabel">Update Oral Examination(Central Viva)</h5>
    ...
    <select class="form-control p-input" name="tech" id="up_tech">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary update_oralexamination">Update Oral Examination(central Viva)</button>
      </div>
    </div>
  </div>
</form>
