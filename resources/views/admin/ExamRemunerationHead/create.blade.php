  ...
  @include('nav')
     ...
     <div class="container card col-8 ml-center " style="background-color:khaki; margin-top: 20px;">
      ...
      <a href="{{URL::to('/allExamRemunerationHead')}}">
                                <button class="btn btn-success btn-ml" >Show All Exam Remuneration Heads List</button>
                              </a>
                          <h2 class="card-title">Add Exam Remuneration Heads List</h2>
                          
                          <form class="forms-sample" method="post" action="{{URL::to('ExamRemunerationHead/strore')}}" enctype="multipart/form-data" style="width:100%; font-size: 15px;">
                            {{csrf_field()}}
                            <div class="form-group">
                                <label for="exampleInputPassword1">Description:</label>
                                 <input type="text" name="head_name" required class="form-control">
                              </div>
                              <div class="form-group">
                                  <label for="exampleInputEmail1">Name and Description of Examination Remuneration Head:</label>
                                  <textarea type="text" class="form-control p-input" name="description"></textarea>
                              </div>
                              <div class="form-group">
                                  <label for="exampleInputEmail1">Academic Level:</label>
                                  <input type="text" class="form-control p-input" name="role">
                              </div>
                              <div class="form-group">
                      <label>Amount:</label>
                      <input type="number" 
                             ...
                             required>
                               ...
                               <div class="form-group">
                                <!-- Hidden field for secret_key -->
                                <input type="hidden" name="secret_key" value="">
                            </div>
                              <div class="form-group">
                                  <label>Condition:</label>
                                  <input type="text" name="condition_text" class="form-control">
                              </div>
