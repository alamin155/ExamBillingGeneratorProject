...
<body>
 ...
 <ul class="nav">
     ...
     <div class="container col-6 card-body" style=" margin-left:270px; width:960px; height:650px; background:pink; border: 2px solid">
      <div class="col-md-14 card-body" style="width:960px">
        <h2 class="my-2 text-center">Examination Duty Stuffs</h2>
          <a href="" class="btn btn-primary my-2" data-bs-toggle="modal" data-bs-target="#addModal">Add New Examination Duty Stuff</a>
          @foreach($exams as $d)
      ...
      <div class="data-table col-md-10" style="width:956px">
            <table class="table table-bordered" style="border: 2px;">
                      ...
                      <tr> 
                       <th>{{$key+1}}</th>
                       <td>{{$d->staff->staff_name}},{{$d->staff->staff_designation}},{{$d->staff->department->department_name}},{{$d->staff->staff_address}}</td>
