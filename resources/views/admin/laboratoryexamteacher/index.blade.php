  ...
  @include('usernave')
     <div class="container col-6 card-body" style=" margin-left:265px; width:1055px;background-color:#e7e6e6; border: 2px solid #A8D08D">
      <div class="col-md-14 card-body" style="width:960px">
        <h2 class="my-2 text-center">All Laboratory Exam Teachers List</h2>
          <a href="" class="btn btn-primary my-2" data-bs-toggle="modal" data-bs-target="#addModal">Add New Laboratory Exam Teacher</a>
          @foreach($exams as $d)
    ...
    <tr>
        ...
        <td>{{ $courseData->first()->course->course_code }}</td>
            <td>@foreach($courseData as $d)
                ...
                {{ $d->teacher->teacher_designation }},Dept. of 
            ...
            <td>{{ $d->student }}</td>
                       <td>
                      <a href="#" class="btn btn-primary update_laboratoryexamteacher_form" 
                      ...
                      <a href="#" class="btn btn-danger delete_laboratoryexamteacher" data-id="{{$d->id}}" >
...
<footer style="width: 1050px;">
  ...
  @include('admin.laboratoryexamteacher.modal')
  @include('admin.laboratoryexamteacher.edit')
  @include('admin.laboratoryexamteacher.ajax')
  {!! Toastr::message() !!}
