...
<div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="addModalLabel" aria-hidden="true" style="margin-top: 60px;">
  <form method="post" action=""  id="addmoderationForm">
   @csrf
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="addModalLabel">Add Moderation Committee</h5>
  ...
  <option value="{{$remk->id}}">{{$remk->remark_title}}</option>
    ...
    <div class="form-group">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary add_moderation">Save Moderation Committee</button>
      </div>
    </div>
  </div>
</form>
