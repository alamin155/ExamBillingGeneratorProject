 ...
 <ul class="nav">
     ...
     <div class="container col-6 card-body" style=" margin-left:270px; width:960px; height:650px; background:skyblue; border: 2px solid">
      <div class="col-md-14 card-body" style="width:960px">
        <h2 class="my-2 text-center">Question Typing and Publishing</h2>
      ...
      <div class="data-table col-md-10" style="width:956px">
            <table class="table table-bordered" style="border: 2px;">
                      ...
                      <tr> 
                       ...
                       <td>{{$d->numberofquestion}}</td>
                       <td>{{$d->numberofpage}}</td>
                       <td>
                      <a href="#" class="btn btn-primary update_questiontypingpublishing_form" 
                      ...
                      data-tech="{{$d->tech_id}}"
                      data-numberofquestion="{{$d->numberofquestion}}"
                      data-numberofpage="{{$d->numberofpage}}"
                      >
                        <i class="las la-edit"></i></a>
                      <a href="#" class="btn btn-danger delete_questiontypingpublishing" data-id="{{$d->id}}" >
  ...
  @include('admin.questiontypingpublishing.modal')
  @include('admin.questiontypingpublishing.edit')
  @include('admin.questiontypingpublishing.ajax')
  {!! Toastr::message() !!}
