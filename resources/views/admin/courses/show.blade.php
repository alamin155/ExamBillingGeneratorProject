...
@include('nav')
   <div class="container col-6 card-body"  style=" margin-left:265px; width:1065px;background-color:#e7e6e6; border: 2px solid #A8D08D">
     <div class="container card col-8 ml-center " style="background-color:khaki; margin-top: 20px;">
             <h2 class="card-title" style="text-align:center;">Only One Course</h2>
              <div class="card-title">
                      <a href="{{URL::to('/allcourses')}}"><button  class="btn btn-success btn-ml deleteStudentBtn">Show All Courses List</button></a> 
                    </div>
                  ...
                  <table  class="table table-striped">
                    ...
                    <tbody>
                      <tr>
                          ...
                          <td><h5>@if($data->course_type==1) Theory @else Lab @endif</h5></td>
                          <td>
